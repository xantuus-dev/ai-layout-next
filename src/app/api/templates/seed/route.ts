...
export async function POST(req: NextRequest) {
  try {
    // SECURITY: seeding writes to the database, so it must be admin-only.
    // This was previously an unauthenticated POST that any caller could use to
    // upsert categories and templates.
