...
interface UsageDashboardProps {
  /**
   * Page heading. Omitted under /settings/usage, where SettingsLayout already
   * supplies an <h1> ("Settings") and a tab bar — a second heading there would
   * read as two stacked page titles.
   */
  title?: string;
}

export default function UsageDashboard({ title }: UsageDashboardProps) {
